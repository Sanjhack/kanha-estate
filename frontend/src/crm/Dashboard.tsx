  ...
  async function loadDashboard() {
    ...
    try {
      ...
      setStats({
        ...
        totalLeads: Number(
          statsData.data.totalLeads || 0
        ),


        newLeads: Number(
          statsData.data.newLeads || 0
        ),


        contactedLeads: Number(
          statsData.data.contactedLeads || 0
        ),


        bookedLeads: Number(
          statsData.data.bookedLeads || 0
        ),
        ...
        availableProperties: Number(
          statsData.data.availableProperties || 0
        ),


        reservedProperties: Number(
          statsData.data.reservedProperties || 0
        ),


        soldProperties: Number(
          statsData.data.soldProperties || 0
        ),



        totalSiteVisits: Number(
          statsData.data.totalSiteVisits || 0
        ),


        totalFollowUps: Number(
          statsData.data.totalFollowUps || 0
        ),
